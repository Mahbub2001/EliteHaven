...
const Register = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      setValue("profile_picture", pp);
      const formData = { ...data, profile_picture: pp };
      const response = await axios.post(
        "https://elitehaven-backend.onrender.com/accounts/register/",
        formData
      );
  ...
  return (
    <>
      <h1 className="text-center text-4xl font-bold text-indigo-600 mt-10">
        Register Here
      </h1>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className={`mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 focus:outline-none transition duration-300 ease-in-out transform hover:scale-105 ${
